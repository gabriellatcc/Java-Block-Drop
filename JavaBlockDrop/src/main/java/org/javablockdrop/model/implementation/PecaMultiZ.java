 ...
 * {@code APecaMulti2Var}, que redefine os valores das coordenadas da peca e a cor que deve ser e, neste caso, vermelho.
 */
public class PecaMultiZ extends APecaMulti2Var {
    public PecaMultiZ() {
        this.c1 = 2;
        this.c2 = 3;
        this.c3 = 11;
